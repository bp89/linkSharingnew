...
<html>
	...
	<body>
		...
		<div id="edit-secretQuestion" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:secretQuestionInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${secretQuestionInstance?.version}" />
				<fieldset class="form">
